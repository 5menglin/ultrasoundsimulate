...
R=15e-3;%focal depth
a=2e-3;%aperture
fnumber=R/a;            %f_number = probe_diameter / focal_depth;
                        %resolution = f_number * wavelength;
...
%defocusing
r=0.0e-3;%displacement of of focal plane. set to zero for max focussing
